    ...
    <main id="content" class="site-main">
            <section class="service-inner-page inner-page-wrap">
               ...
               <div class="inner-banner-wrap">
                  <div class="inner-baner-container" style="background-image: url(assets/web/images/service-wallpaper.jpg);">
                     <div class="container">
                        ...
                        <div class="col-lg-4 col-sm-6">
                           <div class="icon-box bg-img-box" style="background-image: url({{url('/uploads/property/'.$value->image)}});">
                              ...
                              <div class="icon-box-content">
                                 ...
                                 {!! \Illuminate\Support\Str::limit(html_entity_decode($value->commodity_uid), 200) !!}
                  ...
                  <div class="container">
                     <div class="row align-items-center">
                        <div class="col-lg-8 offset-lg-2 text-center">
                           ...
                           <h2 class="section-title">READY FOR UNFORGETTABLE TRAVEL. REMEMBER US!</h2>
