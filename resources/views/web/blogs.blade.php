...
<div class="body-wrapper">
    ...
    <main id="content" class="site-main">
            <div class="inner-banner-wrap">
               ...
               style="background-image: url({{url('assets/web/images/blog-wallpaper.jpeg')}});"
               >
                  <div class="container">
                        ...
                        <div class="grid-item col-md-4">
                              <article class="post">
                                 ...
                                 <div class="post-content">
                                    <div class="cat-meta">
                                       <a href="{{URL::to('/blog-details/'.$data->id)}}">TOUR</a>
                                    </div>
                                    <h3><a href="{{URL::to('/blog-details/'.$data->id)}}">{{$data->title}}</a></h3>
                                    <p> {!! \Illuminate\Support\Str::limit(html_entity_decode($data->content), 50) !!}...</p>
                                    <div class="post-footer d-flex justify-content-between align-items-center">
                                       <div class="post-btn">
                                          <a href="{{URL::to('/blog-details/'.$data->id)}}" class="round-btn">Read More</a>
                                       </div>
