    ...
    <main id="content" class="site-main">
            <section class="contact-inner-page">
               ...
               <div class="inner-banner-wrap">
                  <div class="inner-baner-container" style="background-image: url(assets/web/images/contact-wallpaper.jpeg);">
                     <div class="container">
                     ...
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="section-heading">
                              ...
                              <p>We’re here to help you and answer any Question you might have. 
We look forward to hearing from you
                           ...
                           <div class="contact-map">
                              <iframe src=
                              "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127118.3225092238!2d-3.979664999999999!3d5.3484501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfc1ea5311959121%3A0x3fe70ddce19221a6!2sAbidjan%2C%20C%C3%B4te%20d&#39;Ivoire!5e0!3m2!1sen!2sin!4v1667637039094!5m2!1sen!2sin"
                              width="600" height="400" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                           </div>
                        </div>
                        <div class="col-lg-6">
                           <div class="contact-from-wrap primary-bg">
                              <form action="{{ route('sendEnquiry-123') }}" method="POST" class="contact-from">
                                 @csrf

                              <h4 style="color:white"><b>Drop us a line</b> <br/>
                              <b>We’ll get back to you as soon as possible..</b> </h4>
                                 <p>
...
<option value="263">    Zimbabwe  +263 </option>
                                       ...
                                       <input type="number" name="mob" placeholder="Your Number*" required>
                                    </p>
                                 </div>

                                 <p>
                                    <label>Requirement</label>
                                    <select class="w-100" name="req" required>
                        ...
                        <div class="col-lg-6">
                           <div class="icon-box border-icon-box">
                              ...
                              <div class="icon-box-content">
                                 ...
                                 <ul>
                                    <li>
                                       <a href="Booking@junglebooktourism.com">Booking@junglebooktourism.com</a>
                                    </li>
                        ...
                        <div class="col-lg-6">
                           <div class="icon-box border-icon-box">
                              ...
                              <div class="icon-box-content">
                                 ...
                                 <ul>
                                    <li>
                                       <a href="tell:+225 0706683252"> +225 0706683252
</a>
                                    </li>
                                    <li>
                                      <a href="tell:+225 0705435705"> +225 0705435705 
</a>
                                    </li>
                     ...
                     <div class="col-lg-4">
                           <div class="icon-box border-icon-box">
                              ...
                              <div class="icon-box-content">
                                 ...
                                 <ul>
                                    <li>
                                   Marcory residentiel, Societe Saadi, Abidjan, Cote d'ivoire
                                    </li>
                        ...
                        <div class="col-lg-4">
                           <div class="icon-box border-icon-box">
                              ...
                              <div class="icon-box-content">
                                 ...
                                 <ul>
                                    <li>
                                   1/151, near mehndipur balaji temple, Sundar Nagar, Sunder nagar, Haribhau Upadhyay Nagar, Ajmer, Rajasthan 305001
                                    </li>
