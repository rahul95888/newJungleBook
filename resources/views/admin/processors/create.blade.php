                ...
                <form action="{{ route('processors.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first"  class="row g-3 needs-validation @if($errors->any())was-validated @endif">
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="total_area" required id="total_area" value="{{ old('total_area') }}" >
                            @error('total_area')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="bedroom" required id="bedroom" value="{{ old('bedroom') }}" >
                            @error('bedroom')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number"  class="form-control" name="lounge" required id="lounge" value="{{ old('lounge') }}" >
                            @error('Lounge')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
