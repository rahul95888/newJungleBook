                    ...
                    <table id="processors_table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($data->status=='Featured') { ?>
                                    <span class="tag">
                                <a href="/plan-featured/{{$data['id']}}" class="btn btn-success btn-sm" title="Featured Package">
                                       {{$data->status}}
                                    </a></span>
                                        <?php } else{?>
                                            <span class="tag">
                                <a href="/plan-featured/{{$data['id']}}" class="btn btn-danger btn-sm" title="Featured Package">
                                       Not Featured
                                    </a></span>
                                            <?php } ?>
                                </td>
