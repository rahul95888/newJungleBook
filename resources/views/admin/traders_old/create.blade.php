    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('traders.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first" class="row g-3 needs-validation @if($errors->any())was-validated @endif">
                    @csrf
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="turnover" id="turnover" value="{{ old('turnover') }}">  
                            @error('turnover')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ho_location" id="ho_location" value="{{ old('ho_location') }}">  
                            @error('ho_location')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="trade_regions" id="trade_regions" value="{{ old('trade_regions') }}">  
                            @error('trade_regions')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
