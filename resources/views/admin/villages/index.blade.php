                ...
                <div class="table-responsive">
                    <table id="villages_table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        @php($i = "1")
                            ...
                            <td><a class="btn btn-primary btn-sm me-3" title="Edit Village Details" href="{{ route('villages.edit', $data->id) }}">
                                        <i class="bx bx-edit"></i>
                                    </a>
                                    <button class="btn btn-danger btn-sm deleteItem" title="Delete Village" data-id="{{$data['id']}}">
                                        <i class="bx bx-trash"></i>
                                    </button>
                                    <form id="deleteForm{{$data->id}}" action="{{route('villages.destroy', [$data->id])}}" method="post" style="display:none">
                                        @csrf
                                        @method('delete')
