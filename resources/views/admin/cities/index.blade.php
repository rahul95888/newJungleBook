                ...
                <div class="table-responsive">
                    <table id="cities_table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        @php($i = "1")
                            ...
                            <td><a class="btn btn-primary btn-sm me-3" title="Edit City Details" href="{{ route('cities.edit', $data->id) }}">
                                        <i class="bx bx-edit"></i>
                                    </a>
                                    <button class="btn btn-danger btn-sm deleteItem" title="Delete City" data-id="{{$data['id']}}">
                                        <i class="bx bx-trash"></i>
                                    </button>
                                    <form id="deleteForm{{$data->id}}" action="{{route('cities.destroy', [$data->id])}}" method="post" style="display:none">
                                        @csrf
                                        @method('delete')
